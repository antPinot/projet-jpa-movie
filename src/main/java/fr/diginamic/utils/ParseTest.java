...
public class ParseTest {
	...
	public static void main(String[] args) throws StreamReadException, DatabindException, IOException {
		...
		/*System.out.println(films.get(0).getActeurs());
		
		System.out.println(films.get(0).getRealisateurs());
		
		System.out.println(films.get(0).getGenres());
		
		System.out.println(films.get(0).getRoles());
		
		System.out.println(films.get(0).getPays());
		
		System.out.println(films.get(1).getLieuTournage());*/
		...
		Set<Acteur> acteursFilmOne = imdb.getFilms().get(1).getActeurs();
		
		for (Acteur acteurs : acteursFilmOne) {
