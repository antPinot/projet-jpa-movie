...
public class Film {
	 ...
	 * @param realisateurs
	 */
	public Film(String idImdb, String nom, String url, String plot, String langue, Year anneeSortie, Pays pays,
			Lieu lieuTournage, Set<Genre> genres, Set<Role> roles, Set<Acteur> acteurs, Set<Realisateur> realisateurs) {
		this.idImdb = idImdb;
		this.nom = nom;
		this.url = url;
		this.plot = plot;
